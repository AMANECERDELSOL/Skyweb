...
import { Wifi, Shield, Radio, Smartphone, Monitor, Settings } from 'lucide-react';
              ...
              <button
                onClick={() => {
                  const message = encodeURIComponent(
                    '¡Hola Skyweb! Me interesa conocer más sobre sus servicios personalizados. ¿Podrían contactarme?'
                  );
